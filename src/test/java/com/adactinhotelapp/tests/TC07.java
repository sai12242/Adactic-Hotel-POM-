...
public class TC07 extends BaseTest {
	...
	public void validateSearchHotelTest(HashMap<String, String> dataMap) throws InterruptedException 
	{
		...
		String expectedroomtype =shp.RoomtypeDropdown(dataMap.get("Room Type"));
		...
		String actualroomtype = SelectHotel.RoomtypeOnSelectHotel();
	...
	public Object[][] getTestData()
	{
		...
		HashMap<String, String> testDataMap=ExcelUtils.getTestDataFromExcel("TC07");
