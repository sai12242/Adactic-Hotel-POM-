...
public class TC03 extends BaseTest {
	...
	public void validateSearchHotelTest(HashMap<String, String> dataMap) 
	{
		...
		shp.SearchButton();
		shp.GetCheckInErrorMsg2();
		Assert.assertEquals(shp.GetCheckInErrorMsg2(), AppConstants.CheckInErrormsg2);
	}
	...
	public Object[][] getTestData()
	{
		...
		HashMap<String, String> testDataMap=ExcelUtils.getTestDataFromExcel("TC03");
